...
const Navbar = ({ isHam, setIsHam, theme }) => {
  ...
  return (
    <div className='navigation-cont h-[100%]' style={css}>
      <section className='w-[100%]'>
        <div className='p-0 navigation-btn' onClick={() => { setIsHam(!isHam) }}>{isHam == false ? <RiMenuFill size={40} /> : <RiMenu4Fill size={40} />}</div>
      </section>
